...
@section('content')
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <livewire:teachers :school="0" />
                @else
                <livewire:teachers :school="auth()->user()->school->id" />
                @endrole
                <!--end::Card-->
            </div>
            <!--end::Container-->
    ...
    <div class="modal fade" id="kt_modal_import_schools" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Import School</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form class="form" action="{{ route('app.teachers.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Input group-->
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="fs-6 fw-bold form-label mb-2">Choose Csv/Xlsx File:</label>
                            <!--end::Label-->
                            <!--begin::Input-->
    ...
    <div class="modal fade" id="kt_modal_export_schools" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Export Schools</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
