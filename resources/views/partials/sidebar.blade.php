...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="">
            <img alt="Logo" src="{{ asset('media/logos/emis logo.png') }}" class="h-45px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <!--end::Brand-->
    <!--begin::Aside menu-->
    <div class="aside-menu flex-column-fluid" style="font-size:11.9px;">
        <!--begin::Aside Menu-->
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('app.users.index') }}">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('app.roles.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Data Collection & Management</span>
                        <span class="menu-arrow"></span>
                    </span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="">
                                ...
                                <span class="menu-title">Extra Curricullar</span>
                            </a>
                        </div>
                        <div class="menu-item">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="">
                                ...
                                <span class="menu-title">Other Relevant Educational Aspects</span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('app.monitoring.index') }}">
                        ...
                        <span class="menu-title">Monitoring & Evaluation</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('app.resources.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <span class="menu-title">Resource Planing</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="{{route('app.chat')}}">
                        ...
                        <span class="menu-title">Communication & collaboration</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('app.settings.index') }}">
                        <span class="menu-icon">
                            <i class="fab fa-laravel icon-nm"></i>
                        </span>
