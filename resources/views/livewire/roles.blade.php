        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" wire:model.debounce.300ms='search' class="form-control form-control-solid w-250px ps-14" placeholder="Search role" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="table-responsive">
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('app.roles.edit', $role->id) }}" class="menu-link px-3">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3" id="delete{{ $role->id }}" data-value="{{ $role->id }}">Delete</a>
                                    </div>
                                    <script>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start">
                       Showing {{ $roles->firstItem() }} to {{ $roles->lastItem() }} out of {{ $roles->total() }} entries
                    </div>
